...
DESCRIPTION : This stylesheet fragment is used by other stylesheets to strip
  attributes in the XML pretty printing namespace from an XML document fragment,
  returning an XML document fragment with attribute indentation as determined
  by the pretty printing attributes.
...
DESCRIPTION : This template is the root element for the XML formatting process.
...
DESCRIPTION : Outputs all text nodes without regard to context - this is a
  straight copy for XML output.
=============================================================================-->
...
DESCRIPTION : Outputs all comments without regard to context - a straight copy.
...
DESCRIPTION : Outputs all processing instructions without regard to context -
  a straight copy. Note that if this node is outside of the document element,
...
<xsl:template name="embedded_xml_process_element_namespaces">
  ...
  <!--
    ...
    namespace declaration on the current element. Output this first.
  -->
...
DESCRIPTION : This template is called by `embedded_xml_process_attribute' to
  ...
  (Note that the name of this template comes from the XML->HTML version - in
  the XML->XML version, the non-breaking spaces are in fact just regular
  spaces.)
=============================================================================-->
