...
inoremap ,li <listitem><CR><para></para><CR></listitem><esc>kk$a
inoremap ,l2 <listitem><CR><para></para><CR></listitem>
...
imap ,img <imageobject>><imagedata fileref="" format=""/><esc>12hi
imap ,mo <mediaobject>>,img
